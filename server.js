...
//zebysmy mogli uzywac skryptu z tego katalogu public chyba
...
const url = 
"mongodb+srv://"+mongo_user+":"+mongo_password+"@"+mongo_url+"/contactdatabase?retryWrites=true&w=majority";
...
app.get("/api/contact",function(req,res) {
    contactModel.find().then(function(items) {
